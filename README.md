...
The entire codebase was generated by [Claude](https://claude.ai) via [Claude Code](https://docs.anthropic.com/en/docs/claude-code) with no human-written code. It's not production-grade — there are likely bugs, shortcuts, and possibly fundamental issues in the emulation layers — but we are trying to take it as seriously as possible, because it is an emulator in the end. This started as a fun project to push what Claude can do and to finally make the old [wcecl](https://github.com/dz333n/wcecl) concept actually work. And it does seem to work.
