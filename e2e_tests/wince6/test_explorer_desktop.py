#!/usr/bin/env python3
"""E2E test: WinCE 6 explorer boots, shows desktop with icons and taskbar."""
import sys, os, time
sys.path.insert(0, os.path.dirname(os.path.dirname(__file__)))
from cerf_test_utils import CerfTestRunner, step, passed, failed, TMP_DIR

LOG = os.path.join(TMP_DIR, "e2e_wince6_desktop.txt")
...
try:
    ...
    passed("WinCE 6 explorer boots with desktop and Start menu")
