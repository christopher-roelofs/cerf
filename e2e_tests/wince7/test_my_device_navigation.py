#!/usr/bin/env python3
"""E2E test: WinCE 7 My Device opens via API set dispatch, shows folders."""
import sys, os, time
sys.path.insert(0, os.path.dirname(os.path.dirname(__file__)))
from cerf_test_utils import CerfTestRunner, step, passed, failed, TMP_DIR

LOG = os.path.join(TMP_DIR, "e2e_wince7_mydevice.txt")
...
try:
    ...
    passed("WinCE 7 My Device opens via SHEL API set dispatch")
