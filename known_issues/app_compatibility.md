...
| explorer.exe | WinCE 5 HPC shell — desktop icons with wallpaper, Start Menu (Programs/Favorites/Settings/Run/Suspend), taskbar with clock, launching apps from menu (.lnk shortcuts), right-click Properties opens wallpaper picker, live wallpaper change. Missing: folder navigation (needs COM/IShellFolder), some icons wrong |
